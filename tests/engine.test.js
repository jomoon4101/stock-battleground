...
test("3~7명과 모드별 5·8·11개 섹터 OHLC·거래량 종목을 생성한다", () => {
  ...
  assert.equal(createGame({ playerCount: 99 }).players.length, 7);
...
test("빠른·기본·장기 게임은 10·20·30라운드 제한시간을 사용한다", () => {
  ...
  assert.deepEqual([GAME_MODES.quick.playerCount, GAME_MODES.standard.playerCount, GAME_MODES.long.playerCount], [3, 5, 7]);
